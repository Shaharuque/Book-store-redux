...
import { useDeleteBookMutation } from "../../features/BookApi/bookApiSlice";
import Star from "./Star";

const Book = ({ book }) => {
  const { id, thumbnail, price, name, featured, author, rating } = book;
  const [deleteBook, { isSuccess: deleteSuccess, isError: deleteError }] =
